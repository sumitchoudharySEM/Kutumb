  ...
  return (
    <>
      ...
      <div>
        ...
        <section>
          <div className="container">
            <div className="cs-funfact_wrap cs-type1">
              <div className="cs-funfact_shape" data-src="assets/img/funfact_shape_bg.svg" />
            ...
            <div className="cs-slider_container" data-autoplay={0} data-loop={1} data-speed={600} data-center={1} data-slides-per-view={1}>
              <div className="cs-slider_wrapper">
                <div className="cs-slide">
                  <a href="portfolio-details.html" className="cs-portfolio cs-style1 cs-bg">
                    <div className="cs-portfolio_hover" />
                    <div className="cs-portfolio_bg" data-src="assets/img/portfolio_1.jpeg" />
                ...
                <div className="cs-slide">
                  <a href="portfolio-details.html" className="cs-portfolio cs-style1 cs-bg">
                    <div className="cs-portfolio_hover" />
                    <div className="cs-portfolio_bg" data-src="assets/img/portfolio_2.jpeg" />
                    <div className="cs-portfolio_info">
                      <div className="cs-portfolio_info_bg cs-accent_bg" />
                      <h2 className="cs-portfolio_title">Colorful Art Work</h2>
                      <div className="cs-portfolio_subtitle">See Details</div>
                ...
                <div className="cs-slide">
                  <a href="portfolio-details.html" className="cs-portfolio cs-style1 cs-bg">
                    <div className="cs-portfolio_hover" />
                    <div className="cs-portfolio_bg" data-src="assets/img/portfolio_3.jpeg" />
                    <div className="cs-portfolio_info">
                      <div className="cs-portfolio_info_bg cs-accent_bg" />
                      <h2 className="cs-portfolio_title">Colorful Art Work</h2>
                      <div className="cs-portfolio_subtitle">See Details</div>
        ...
        {/* Start General Text */}
        <div className="container">
          <h2 className="cs-font_50 cs-m0 text-center cs-line_height_4 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s"> Our agile process is ability to adapt and respond to change. Agile organizations view change as an opportunity, not a threat. </h2>
        </div>
        {/* End General Text */}
        <div className="cs-height_70 cs-height_lg_70" />
        {/* Start Video Block */}
        <div className="container">
          <a href="https://www.youtube.com/watch?v=VcaAVWtP48A" className="cs-video_block cs-style1 cs-video_open cs-bg" data-src="assets/img/video_bg.jpeg">
                  ...
                  <div className="slider-for_item">
                    <div className="cs-testimonial cs-style1">
                      ...
                      <div className="cs-rating" data-rating={4}>
                        <div className="cs-rating_bg" data-src="assets/img/rating.svg" />
                        <div className="cs-rating_percentage" data-src="assets/img/rating.svg" />
                      </div>
